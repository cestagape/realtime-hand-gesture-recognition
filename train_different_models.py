        ...
        for l_rate in [0.1, 0.2]:
            for l2 in [0.001, 0.0001]:
                for b in [256, 512]:
                    ...
                    acc_val = mf.accuracy(y_pred_val, mf.one_hot_encode(labels_val, 4))
                    ...
                    confusion_val = confusion_matrix_multiclass(y_pred_val, labels_val)
                    save_confusion_matrix(confusion_val, n, l_rate, l2, f1_score_macro_train, f1_score_macro_validation, acc_train, acc_val, b)
